...
def spearmanr(x, y, axis=1, top_k=None):
    ...
    if top_k is not None:
        logger.info(f'Calculating Spearman correlation coefficient on {n_samples} molecules with selection of top {top_k} molecules')
    else:
        logger.info(f'Calculating Spearman correlation coefficient on {n_samples} molecules')
    ...
    logger.debug('Computing pairwise correlation coefficient...')

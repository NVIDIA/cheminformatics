...
# Location of original data: https://deepchemdata.s3-us-west-1.amazonaws.com/datasets/Lipophilicity.csv

DATA_BENCHMARK_DIR = os.path.join(pathlib.Path(__file__).absolute().parent.parent,
                                'csv_data')
columns = ['SMILES'] 
physchem_columns = ['exp']

if __name__ == '__main__':
    data_benchmark_path = os.path.join(DATA_BENCHMARK_DIR, 'benchmark_MoleculeNet_Lipophilicity.csv')

...
if __name__ == '__main__':
    data_benchmark_path = os.path.join(DATA_BENCHMARK_DIR, 'benchmark_MoleculeNet_FreeSolv.csv')
    ...
    # Write results
    fp = fp.reset_index()
    fp.to_csv(os.path.join(DATA_BENCHMARK_DIR, 'fingerprints_MoleculeNet_FreeSolv.csv'), index=False)
